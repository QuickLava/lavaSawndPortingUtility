...
namespace lava
{
	...
	bool byteArray::setDouble(double valueIn, std::size_t atIndex)
	{
		return setObj<double>(valueIn, atIndex);
	}
	bool byteArray::setFloat(float valueIn, std::size_t atIndex)
	{
	...
	bool byteArray::insertDouble(double valueIn, std::size_t atIndex)
	{
		return insertObj<double>(valueIn, atIndex);
	}
	bool byteArray::insertFloat(float valueIn, std::size_t atIndex)
	{
